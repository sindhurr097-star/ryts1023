# Sense AI - Detect - Predict - Prevent - Industrial Predictive Maintenance System
...
- **AI Chatbot**: SenseBot assistant for natural language queries about machine health
