  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-white border border-gray-200 rounded-lg text-primary shadow-sm"
      >
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-full bg-white border-r border-gray-200 z-50 shadow-sm
      ...
      `}>
        ...
        <div className="p-4 border-b border-gray-200">
          <button
            ...
            className="hidden lg:flex w-full items-center justify-center p-2 rounded-lg hover:bg-gray-100 transition-colors"
          >
              ...
              <Link
                ...
                className={`
                  ...
                  ${isActive(item.path) 
                    ...
                    : 'text-textMuted hover:bg-gray-100 hover:text-textPrimary'
                  }
                  ...
                  {machineIds.map((machineId) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={() => setMobileOpen(false)}
                        className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-textMuted hover:bg-gray-100 hover:text-textPrimary transition-colors"
                      >
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            className={`
              flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-200
              w-full text-textMuted hover:bg-gray-100 hover:text-textPrimary
              ${collapsed ? 'justify-center' : ''}
            `}
          >
            <Mic size={20} />
