...
import VoiceButton from '../VoiceModule/VoiceButton';
...
const ChatbotWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[380px] h-[500px] bg-white border border-gray-200 rounded-xl shadow-lg flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-textPrimary">SenseBot</h3>
              ...
              <div className="space-y-2">
                ...
                {suggestions.map((suggestion, index) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm text-textPrimary transition-colors"
                  >
                    {suggestion}
                  </button>
                ))}
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 bg-white border border-gray-300 rounded-lg px-4 py-2 text-sm text-textPrimary placeholder-gray-400 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
              />
              <button
                onClick={() => handleSend()}
