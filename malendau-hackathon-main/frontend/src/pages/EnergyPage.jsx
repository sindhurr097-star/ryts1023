...
const EnergyPage = () => {
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
      ...
      case 'Hard': return 'bg-danger/20 text-danger border-danger/30';
  ...
  const calculateEnergyEfficiency = () => {
    ...
    const baseline = machines[selectedMachine]?.current_A * machines[selectedMachine]?.rpm / 1000;
    const efficiency = ((baseline / power) * 100).toFixed(1);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="bg-surfaceBorder rounded-lg p-4 text-center">
