            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-surfaceBorder text-textPrimary rounded-lg hover:bg-surfaceBorder/80 transition-colors"
                >
                  Clear
                </button>
              </div>
          ...
          <div className="glass-card rounded-xl p-6">
            ...
            {loading && (
              <div className="flex flex-col items-center justify-center h-96 text-textMuted">
                <div className="w-12 h-12 border-4 border-surfaceBorder border-t-primary rounded-full animate-spin mb-4" />
            ...
            {!loading && report && (
              <div className="space-y-4">
                <div className="bg-surfaceBorder rounded-lg p-4 max-h-96 overflow-y-auto scrollbar-thin">
