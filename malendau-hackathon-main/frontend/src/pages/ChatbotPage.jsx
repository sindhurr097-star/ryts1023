        ...
        <div className="glass-card rounded-xl flex flex-col h-[calc(100%-100px)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {suggestions.map((suggestion, index) => (
                    <button
                      ...
                      className="text-left px-4 py-3 bg-surfaceBorder hover:bg-surfaceBorder/80 rounded-lg text-sm text-textPrimary transition-colors"
                    >
                      {suggestion}
                    </button>
                  ))}
          ...
          <div className="p-4 border-t border-surfaceBorder">
            <div className="flex items-center gap-3">
              <button className="p-2 bg-surfaceBorder hover:bg-surfaceBorder/80 text-textPrimary rounded-lg transition-colors">
                <Mic size={20} />
              </button>
              <input
                type="text"
                ...
                className="flex-1 bg-surface border border-surfaceBorder rounded-lg px-4 py-3 text-textPrimary placeholder-textMuted focus:outline-none focus:border-primary"
              />
              <button
                onClick={() => handleSend()}
