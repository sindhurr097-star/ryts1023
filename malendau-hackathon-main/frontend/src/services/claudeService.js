...
export const chatMessage = async (conversationHistory, userMessage, allMachineSummaries) => {
  const system = `You are JnanikBot, an AI assistant for industrial predictive maintenance. Current machine status: ${JSON.stringify(allMachineSummaries)}. Answer questions about machine health, alerts, and maintenance. Be concise and helpful. Keep responses under 200 words.`;
